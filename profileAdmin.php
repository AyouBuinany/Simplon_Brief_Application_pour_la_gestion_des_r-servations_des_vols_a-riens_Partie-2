       ...
       <div class="container sb-left">
           ...
           <div class="page-wrapper">
               <div class="page-content">
                   <div class="head-btns">
                   <a class="back btn" href="pageGestion.php"><i class="fn left-arrow"></i><span>Back to Gestion</span></a>
        ...
        <h3 style="text-align:center"> list des flights_list</h3>
        ...
        <table class="table mr-4">
            ...
            <tr>
                ...
                <th>Seats</th>
                <th style="background-color:#f07d43;">id_user</th>
                <th>statusflight</th>
            </tr>
        </thead>
        <tbody id="T_table">
